...
{/* Top Navigation Bar */}
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-zinc-950/70 border-b border-zinc-800/80 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex-1 flex items-center justify-start space-x-3 w-full sm:w-auto">
          ...
          <span className="px-2.5 py-0.5 rounded-full bg-zinc-900 border border-zinc-800 text-[10px] text-zinc-400 font-medium tracking-widest uppercase">
            v1.0
          </span>
        </div>
        ...
        {/* Logout (flex-1 ensures this balances out the left side) */}
        <div className="flex-1 flex justify-end w-full sm:w-auto min-w-[80px]">
